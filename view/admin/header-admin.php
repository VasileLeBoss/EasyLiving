...
session_start();
include('../../controls/check_admin.php');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<header class="header-admin-panel space-between">
<ul >
    <li >
            ...
            <h1>
                    <a href="index.php" class="logo-admin user">
    ...
    <li>
        ...
        <h3><span class="aligne-icon"><ion-icon name="people-circle-outline"></ion-icon><span class="user">Utilisateurs</span></span></h3></a>
    </li>
    <hr>
    <li>
...
<ul>
    <li>
        <a href="../../index.php"><span class="aligne-icon"><ion-icon name="arrow-back-outline"></ion-icon><span class="user">Retour</span></span></a>
    </li>
</ul>
</header>
    ...
    <?php else : ?>
        <li>
            <span class="user" id="user" onclick="toggleUserMenu(event)">
                <div class="relative">
                    <span class="notification-absolute-menu"></span><ion-icon name="person-circle-outline"></ion-icon>
                </div>
            </span>
            <ul class="user-menu " id="userMenu">
                ...
                <a class="relative" href="v_compte-annonce.php"><li><span class="aligne-icon"><ion-icon name="grid-outline"></ion-icon>Gérer mes annonces <span class="notification-relative "></span></span></li></a>
                <hr>
        ...
        <li class="show-on-mobile"><a class="menu"><span class="relative align-verticaly align-horizontaly"><span class="notification-absolute-menu"></span><ion-icon name="menu-outline"></ion-icon></span></a></li>
    <?php endif; ?>
</ul>
</div>
...
<ul class="menu-items">
    ...
    <?php else : ?>
        <hr>
                ...
                <hr>
                <a href="v_view-voyage.php"><li><span class="aligne-icon"><ion-icon name="paper-plane-outline"></ion-icon>Voyages</span></li></a>
                <a href="v_compte-annonce.php"><li><span class="aligne-icon relative"><ion-icon name="grid-outline"></ion-icon>Gérer mes annonces<span class="notification-absolute-menu notification-absolute-mobile"></span></span></li></a>
                <a href="v_depot-annonce.php"><li><span class="aligne-icon"><ion-icon name="add-outline"></ion-icon>Déposer une annonce</span></li></a>
                <hr>
                <a href="../controls/deconnexion.php"><li><span class="aligne-icon"><ion-icon name="log-out-outline"></ion-icon>Se déconnecter</span></li></a>
                <hr>
