...
<ul >
    <li >
            <a href="index.php" class="menu "><span><ion-icon name="grid-outline"></ion-icon></span></a>
            <h1>
    ...
    <li>
        <a href="index.php?view=locataires">
            <h3><span class="aligne-icon"><ion-icon name="location-outline"></ion-icon><span class="user">Locataires</span></span></h3>
        </a>
    </li>
    </div>
    <hr>
