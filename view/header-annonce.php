...
<header class="header-grid background-white">
<div>
...
<li><a href="v_accueil.php"><button class="enregistre-annonce"><span class="aligne-icon">Enregistrer et quitter</span></button></a></li>
</ul>
</div>
</header>